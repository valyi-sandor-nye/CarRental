package hu.valyis.progenv.persistence.impl;
...
public class CarDAODBimpl implements CarDAO {
    ...
    @Override public void createCar(Car car) throws SQLException {
    ...
    @Override public Car getCarById(int id) throws SQLException {
    ...
    @Override public List<Car> getAllCars() throws SQLException {
    ...
    @Override public void deleteCar(int id) throws SQLException {
     ...
     */
    @Override public List<Car> searchCars(int minSeats, int maxSeats, double maxPrice, String brand, String model) throws SQLException {
        List<Car> cars = new ArrayList<>();
